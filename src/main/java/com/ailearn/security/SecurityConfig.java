    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/chat", "/memory", "/rag", "/agent", "/search-agent", "/structured", "/tools", "/multi-agent", "/mcp").permitAll()
                        .requestMatchers("/api/chat/**").permitAll()
                        .requestMatchers("/api/memory/**").permitAll()
                        .requestMatchers("/api/rag/**").permitAll()
                        .requestMatchers("/api/agent/**").permitAll()
                        .requestMatchers("/api/search-agent/**").permitAll()
                        .requestMatchers("/api/structured/**").permitAll()
